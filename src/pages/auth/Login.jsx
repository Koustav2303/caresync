...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        setIsLoading(false);
        // Trigger global login state, which also handles redirection to Home
        login(); 
      }, 1500);
    }
  };
  ...
  return (
    <div ref={formRef} className="w-full">
      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          <Button variant="outline" type="button" className="w-full flex items-center justify-center gap-2 hover:bg-gray-50 text-gray-700 border-gray-200">
